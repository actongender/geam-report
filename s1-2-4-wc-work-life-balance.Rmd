...
```{r val=var_exists("WCWI006"), fig.cap=get_caption("WCWI006") }
...
```{r val=var_exists("WCWI008"), fig.cap=get_caption("WCWI008") }
...
```{r val=var_exists("WCWI010"), fig.cap=get_caption("WCWI010") }
...
```{r val=var_exists("WCWI009"), fig.cap=get_caption("WCWI009") }
...
```{r fig.height=5.2, fig.cap=get_caption("WCWI005.SQ001.")}
...
```{r fig.height=7, fig.width=8, fig.cap=get_caption("EWCS89JobSatisfact8.SQ001.")}
...
```{r fig.height=4.8, fig.cap=get_caption("EWCS36WorkIntensity2.SQ001.")}
...
```{r fig.height=5, fig.cap=get_caption("WorkFamConfISSP.SQ001.")}
...
```{r fig.height=8.5, fig.width=7, fig.cap=get_caption("Covid.SQ01.")}
