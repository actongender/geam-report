...
```{r val=exechunk("WCWI011a"), fig.cap=get_caption("WCWI011a")}
...
```{r val=exechunk("WCWI014"), fig.cap=get_caption("WCWI014") }
...
```{r val=exechunk("WCWI015"), fig.cap=get_caption("WCWI015") }
...
```{r fig.height=7, fig.width=8, fig.cap=get_caption("WCWI016.SQ001.")}
...
```{r fig.height=7, fig.width=8, fig.cap=get_caption("WCWI018.SQ001.")}
...
```{r val=exechunk("WCWI020"), fig.cap=get_caption("WCWI020") }
...
```{r fig.height=8, fig.width=8, fig.cap=get_caption("WCWI021.SQ001.")}
