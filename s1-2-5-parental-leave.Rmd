...
```{r_eval=exechunk("WCWI011a"), fig.cap=get_caption("WCWI011a")}
...
```{r_eval=exechunk("WCWI014"), fig.cap=get_caption("WCWI014") }
...
```{r_eval=exechunk("WCWI015"), fig.cap=get_caption("WCWI015") }
