...
```{r, fig.height=6, fig.width=8, fig.cap=get_caption("BACD003.SQ001.")}
...
```{r fig.height=9, fig.width=8, fig.cap=get_caption("BACD005.SQ001.")}
...
```{r val=exechunk("BACD007"), fig.cap=get_caption("BACD007") }
